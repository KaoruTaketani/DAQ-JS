...
import ForceGetter from "./ForceGetter.js";
import ForceVariables from "./ForceVariables.js";
import PathMaker from "./PathMaker.js";

const variables = new ForceVariables()
new PathMaker(variables)
new FilesGetter(variables)
new ForceGetter(variables)
    ;
(element => {
    element.size = 20
