...
import DensityGetter from "./DensityGetter.js";
import DensityVariables from "./DensityVariables.js";
import PathMaker from "./PathMaker.js";

const variables = new DensityVariables()
new PathMaker(variables)
new FilesGetter(variables)
new DensityGetter(variables)
    ;
(element => {
    element.size = 20
