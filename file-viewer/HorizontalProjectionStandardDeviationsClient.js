...
import HorizontalProjectionStandardDeviationsGetter from "./HorizontalProjectionStandardDeviationsGetter.js";
...
new HorizontalProjectionStandardDeviationsGetter(variables)
    ;
(element => {
    element.size = 20
