...
export default class {
    ...
    constructor(variables) {
        ...
        this._operation = () => {
            if (this._url.pathname !== '/horizontalProjectionStandardDeviations') return
            ...
            const dataset = /** @type {import('h5wasm').Dataset|null} */(f.get('horizontalProjectionStandardDeviations'))
            if (!dataset) {
