...
test('example input of LUDecomposition in Mathematica', () => {
    ...
    strictEqual(L[0][1], 0)
    strictEqual(L[0][2], 0)
    isapprox(L[1][0], 0.151899)
    // isapprox(L[1][0], 0.15189872) if use fround
    strictEqual(L[1][1], 1)
    strictEqual(L[1][2], 0)
    isapprox(L[2][0], 0.139241)
    isapprox(L[2][1], 0.789688)
    strictEqual(L[2][2], 1)
    ...
    strictEqual(U[1][0], 0)
    isapprox(U[1][1], 3.41266)
    isapprox(U[1][2], 2.42532)
    strictEqual(U[2][0], 0)
    strictEqual(U[2][1], 0)
    isapprox(U[2][2], -4.12537)

    strictEqual(size(P).length, 2)
    strictEqual(size(P)[0], 3)
    strictEqual(size(P)[0], 3)
    deepStrictEqual(P, [[0, 1, 0], [1, 0, 0], [0, 0, 1]])
})
...
test('example input of mldivide in matlab', () => {
    ...
    isapprox(L[1][1],1)
    isapprox(L[1][2],0)
    isapprox(L[2][0],0.375)
    isapprox(L[2][1],0.5441176)
    isapprox(L[2][2],1)
    strictEqual(size(U).length, 2)
    strictEqual(size(U)[0], 3)
    strictEqual(size(U)[0], 3)
    ...
    isapprox(U[2][0],0)
    isapprox(U[2][1],0)
    isapprox(U[2][2],5.2941176)
    deepStrictEqual(P, [[1, 0, 0], [0, 0, 1], [0, 1, 0]])
})
...
test('example input of lu in matlab', () => {
    ...
    strictEqual(U[2][0], 0)
    strictEqual(U[2][1], 0)
    isapprox(U[2][2], -0.5714286)
    deepStrictEqual(P,[[1,0,0],[0,1,0],[0,0,1]])
})
