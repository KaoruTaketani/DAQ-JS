...
test('y scale is log', () => {
    const ax = {
        xLim: [0, 1], xTick: [0, 1], xTickLabel: ['0', '1'],
        yLim: [1e-5, 1], yTick: [1e-5, 1], yTickLabel: ['1e-5', '1'],
        yScale: 'log'
    }
    strictEqual(
        axes(ax),
        [
            ...
            '<text x="73" y="389" text-anchor="middle" dominant-baseline="central" font-size="12" >0</text>',
            '<text x="507" y="389" text-anchor="middle" dominant-baseline="central" font-size="12" >1</text>',
            '<text x="68" y="374" text-anchor="end" dominant-baseline="central" font-size="12" >1e-5</text>',
            '<text x="68" y="32" text-anchor="end" dominant-baseline="central" font-size="12" >1</text>'
        ].join('')
    )
})

test('y scale is log and not all ticks are on the limit', () => {
    const ax = {
        xLim: [0, 1], xTick: [0, 1], xTickLabel: ['0', '1'],
        yLim: [1e-5, 1], yTick: [1e-5, 1e-3, 1], yTickLabel: ['1e-5', '1e-3', '1'],
        yScale: 'log'
    }
    strictEqual(
        axes(ax),
        [
            ...
            '<text x="507" y="389" text-anchor="middle" dominant-baseline="central" font-size="12" >1</text>',
            '<text x="68" y="374" text-anchor="end" dominant-baseline="central" font-size="12" >1e-5</text>',
            '<text x="68" y="237" text-anchor="end" dominant-baseline="central" font-size="12" >1e-3</text>',
            '<text x="68" y="32" text-anchor="end" dominant-baseline="central" font-size="12" >1</text>'
        ].join('')
    )
})
