...
export default class {
    constructor() {
        ...
        this.velocityInMeterPerSecond = new WritableNumberArray('velocityInMeterPerSecond', this.hdf5File)
        ...
        this.miezeTimeInPicoseconds = new WritableNumberArray('miezeTimeInPicoseconds', this.hdf5File)
        ...
        this.moderatorSampleDistanceInMeters = new WritableNumber('moderatorSampleDistanceInMeters', this.hdf5File)
