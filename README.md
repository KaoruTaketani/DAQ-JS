...
graph TD;
    ...
    randomNumberGeneratorDestinationState-->histogramBinCounts;
    randomNumber-->randomNumberInnerText;
    randomNumber-->histogramBinCounts;
    %%randomNumber-->timeSeries;
    %%randomNumberGeneratorDestinationState-->timeSeries;
    randomNumberGeneratorDestinationState-->startTime;
    randomNumberGeneratorDestinationState-->startButtonDisabled;
    randomNumberGeneratorDestinationState-->stopButtonDisabled;
