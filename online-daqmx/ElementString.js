export default class {
     ...
     * @param {import('./ListenableObject').default<Map<string,boolean|string>>} elementValues 
     * @param {import('./ListenableObject').default<Map<import('ws').WebSocket,string>>} webSocketPathnames 
     */
