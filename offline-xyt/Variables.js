...
export default class {
    constructor() {
        ...
        this.imageVProjectionBinLimitsInMillimeters = new WritableArray('binLimitsInMillimeters', this.hdf5File, this.imageVProjectionBinCounts)
        this.imageHProjectionBinLimitsInMillimeters = new WritableArray('binLimitsInMillimeters', this.hdf5File, this.imageHProjectionBinCounts)
        this.tofHistogramBinLimitsInNanoseconds = new WritableArray('binLimitsInNanoseconds', this.hdf5File, this.tofHistogramBinCounts)
        this.tofImageZBinLimitsInNanoseconds = new WritableArray('zBinLimitsInNanoseconds', this.hdf5File, this.tofImageBinCounts)
        this.tofImageXBinLimitsInPixels = new WritableArray('xBinLimitsInPixels', this.hdf5File, this.tofImageBinCounts)
        this.tofImageYBinLimitsInPixels = new WritableArray('yBinLimitsInPixels', this.hdf5File, this.tofImageBinCounts)
        this.tofDifferenceHistogramBinLimitsInNanoseconds = new WritableArray('binLimitsInNanoseconds', this.hdf5File, this.tofDifferenceHistogramBinCounts)
        this.imageXBinLimitsInMillimeters = new WritableArray('xBinLimitsInMillimeters', this.hdf5File, this.imageBinCounts)
        this.imageYBinLimitsInMillimeters = new WritableArray('yBinLimitsInMillimeters', this.hdf5File, this.imageBinCounts)
        this.pulseHeightHistogramBinLimits = new WritableArray('binLimits', this.hdf5File, this.pulseHeightHistogramBinCounts)
        this.tofImageVProjectionYBinLimitsInMillimeters = new WritableArray('yBinLimitsInMillimeters', this.hdf5File, this.tofImageVProjectionBinCounts)
        this.tofImageVProjectionXBinLimitsInNanoseconds = new WritableArray('xBinLimitsInNanoseconds', this.hdf5File, this.tofImageVProjectionBinCounts)
        this.filteredImageXBinLimitsInMillimeters = new WritableArray('xBinLimitsInMillimeters', this.hdf5File, this.filteredImageBinCounts)
        this.filteredImageYBinLimitsInMillimeters = new WritableArray('yBinLimitsInMillimeters', this.hdf5File, this.filteredImageBinCounts)
        this.tofImageVProjectionSumsXLimitsInNanoseconds = new WritableArray('xLimitsInNanoseconds', this.hdf5File, this.tofImageVProjectionSums)
        this.tofImageVProjectionSumsYLimitsInMillimeters = new WritableArray('yLimitsInMillimeters', this.hdf5File, this.tofImageVProjectionSums)
        this.tofImageVProjectionContrastsXLimitsInNanoseconds = new WritableArray('xLimitsInNanoseconds', this.hdf5File, this.tofImageVProjectionContrasts)
        this.tofImageVProjectionContrastsYLimitsInMillimeters = new WritableArray('yLimitsInMillimeters', this.hdf5File, this.tofImageVProjectionContrasts)
        this.tofImageVProjectionPhasesXLimitsInNanoseconds = new WritableArray('xLimitsInNanoseconds', this.hdf5File, this.tofImageVProjectionPhases)
        this.tofImageVProjectionPhasesYLimitsInMillimeters = new WritableArray('yLimitsInMillimeters', this.hdf5File, this.tofImageVProjectionPhases)
